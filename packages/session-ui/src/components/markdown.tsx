...
export function Markdown(
  ...
  createEffect(() => {
    ...
    const localFiles = local.openLocalFile
      ? {
    ...
    content.forEach((block, index) => updateBlock(container, index, block, labels, localFiles))
...
function updateBlock(
  ...
  decorate(next, labels, localFiles)
